...
- Behavior Parameters - компонент для настройки поведения экземпляра агента и свойств мозга. Во время выполнения этот компонент генерирует объекты политики агента в соответствии с настройками, указанными в редакторе.

## Задание 3
#### Доработайте сцену и обучите ML-Agent таким образом, чтобы шар перемещался между двумя кубами разного цвета. Кубы должны, как и в первом задании, случайно изменять координаты на плоскости.
Шар катается между двумя кубами, сначала к одному, потом к другому

![Снимок экрана (105)](https://user-images.githubusercontent.com/103362515/201111598-0e411ba7-e115-4ea9-9b71-70cf9a9ca4df.png)
![Снимок экрана (106)](https://user-images.githubusercontent.com/103362515/201111620-df1ba136-8654-4313-83f0-9fece507f5fb.png)
![Снимок экрана (107)](https://user-images.githubusercontent.com/103362515/201111635-eb678dfd-3f45-423a-b7bd-4b3d5cdd316c.png)
![Снимок экрана (108)](https://user-images.githubusercontent.com/103362515/201111645-4d631398-4051-423a-bef6-a938cba415ec.png)
![Снимок экрана (109)](https://user-images.githubusercontent.com/103362515/201111654-695bb4d6-df0d-4692-99ec-344ea6cbfdea.png)

## Выводы
Баланс - это очень увлекательная и необходимая вещь в GameDev-е. Без него игра становится неинтересной. Правильно настроенный игровой баланс уравновешивает возможности и силы объектов, игроков, персонажей, и многим другим объектам игры.
Машинное обучение способно провести множество игровых моментов за короткие сроки, собрать отзывы и сделать корректировки в игровом балансе.
Данная лабораторная работа показалась сначала сложной, пока не начал ее делать. По пути решения задач узнаешь много нового и интересного.
